        ...
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link href="https://www.github.com/naveenkarmegam" target="_blank" rel="noopener noreferrer">
                  GitHUb
                </Footer.Link>
                <Footer.Link href="https://www.linkedin.com/in/naveenkarmegam" target="_blank" rel="noopener noreferrer">LinkedIn</Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
